...
Socialplayer is a little yet powerful and extensive library for powering createPlayer experience on the web. It is
...
Simply importing the utilities you need from `@socialplayer/core`
...
createPlayer.use(hlsPlaybackPlugin)
